...
public class GeradorDePagamento {
	...
	private LocalDate proximoDiaUtil(LocalDate dataBase){
		DayOfWeek diasDaSemana = dataBase.getDayOfWeek();

		if (diasDaSemana == DayOfWeek.SATURDAY) return dataBase.plusDays(2);
		else if (diasDaSemana == DayOfWeek.SUNDAY)  return dataBase.plusDays(1);
